...
import {OracleABI, LinkTokenABI, PriceQueryBytecode, PriceQueryABI} from './bytecodes.js';
...
async function main() {
  ...
  let contract = new web3.eth.Contract(PriceQueryABI, contractAddr);
  console.log((await contract.methods.currentPrice().call()));
  
  // await sendTokens(web3, tokenAddr, LinkTokenABI, bob, contractAddr, web3.utils.toBN(100));
